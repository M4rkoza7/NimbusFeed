...
import { File as File2 } from "buffer";
...
import { File as File3 } from "buffer";
...
var AudioPlayer = class extends EventEmitter2 {
   ...
   */
  isStream(input) {
    return input instanceof Readable4;
  }
  /**
  ...
  playStreamingAudio(audioStream, source, type) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const channels = 1;
        const source2 = new AudioSource(sampleRate, channels);
        const sourceId = `stream_${Date.now()}`;
        this.audioSources.set(sourceId, source2);
        const track = LocalAudioTrack.createAudioTrack("audio", source2);
    ...
    return __async(this, null, function* () {
      ...
      return new Promise((resolve, reject) => {
        const processAudio = () => __async(this, null, function* () {
          try {
            const source = new AudioSource(48e3, 1);
